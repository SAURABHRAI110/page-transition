(function e(t, n) {
    ...
    return function (e) {
        ...
        var J = function () {
            ...
            i(e, [{
                ...
                value: function e() {
                    ...
                    this.delegatedListeners.formSubmit = (0, s.default)(document, this.options.FORM_SELECTOR, "submit", this.formSubmitHandler.bind(this));
                    ...
                    if (!t.metaKey) {
                        if (t.button === 0) {
                            ...
                            if (n.getAddress() == this.currentUrl || n.getAddress() == "") {
                                ...
                                var o = t.delegateTarget.dataset.swupTransition;
                                this.loadPage({
                                    url: n.getAddress(),
                                    customTransition: o
                                }, false)
                ...
                value: function e(t) {
                    ...
                    if (this.options.preload) {
                        ...
                        if (r.getAddress() != this.currentUrl && !this.cache.exists(r.getAddress()) && this.preloadPromise == null) {
                            this.preloadPromise = new Promise(function (e, i) {
                                n.getPage({
                                    url: r.getAddress()
                                }, function (o, s) {
                                    if (s.status === 500) {
                ...
                value: function e(t) {
                    if (!t.metaKey) {
                        ...
                        i.setPath(n.action);
                        if (i.getHash() != "") {
                            this.scrollToElement = i.getHash()
                        }
                        if (n.method.toLowerCase() != "get") {
                            this.cache.remove(i.getAddress());
                            this.loadPage({
                                url: i.getAddress(),
                                method: n.method,
                                data: r
                            ...
                            s.forEach(function (e) {
                                if (e.type == "checkbox" || e.type == "radio") {
                                    if (e.checked) {
                                        o += encodeURIComponent(e.name) + "=" + encodeURIComponent(e.value) + "&"
                                    }
                                } else {
                                    o += encodeURIComponent(e.name) + "=" + encodeURIComponent(e.value) + "&"
                                }
        ...
        e.exports = function (e) {
            ...
            o.setRequestHeader("X-Requested-With", "swup");
            o.send(i.data);
            return o
        }
    }, function (e, t, n) {
        ...
        e.exports = function (e, t) {
            var n = this;
            var i = e.replace("<body", '<div id="swupBody"').replace("</body>", "</div>");
            var o = document.createElement("div");
            o.innerHTML = i;
            var s = [];
            for (var a = 0; a < this.options.elements.length; a++) {
                if (o.querySelector(this.options.elements[a]) == null) {
                    console.warn("Element " + this.options.elements[a] + " is not found in cached page.");
                    return null
                } else {
                    (0, r.queryAll)(this.options.elements[a]).forEach(function (e, t) {
                        (0, r.queryAll)(n.options.elements[a], o)[t].dataset.swup = s.length;
                        s.push((0, r.queryAll)(n.options.elements[a], o)[t].outerHTML)
                    })
                }
            }
            var l = {
        ...
        e.exports = function (e, t) {
            ...
            if (e.customTransition != null) {
                ...
                document.documentElement.classList.add("to-" + this.classify(e.customTransition))
            } else {
            ...
            if (!t || this.options.animateHistoryBrowsing) {
                ...
                var s = (0, r.queryAll)(this.options.animationSelector);
                i.call(s, function (e) {
            ...
            if (this.cache.exists(e.url)) {
                ...
                if (!this.preloadPromise || this.preloadPromise.route != e.url) {
                    var l = new Promise(function (t, r) {
                        n.getPage(e, function (i, o) {
                            if (o.status === 500) {
                                n.triggerEvent("serverError");
                                r(e.url);
                                return
                            } else {
                                var s = n.getDataFromHtml(i, o);
                                if (s != null) {
                                    s.url = e.url
                                } else {
                                    r(e.url);
            ...
            Promise.all(o.concat([l])).then(function () {
        ...
        e.exports = function (e, t) {
            ...
            var i = new o.default;
            i.setPath(e.responseURL);
            if (window.location.pathname !== i.getPath()) {
                window.history.replaceState({
                    url: i.getPath(),
                    random: Math.random(),
                    source: "swup"
                }, document.title, i.getPath())
            }
            if (!t || this.options.animateHistoryBrowsing) {
            ...
            var l = (0, r.queryAll)(this.options.animationSelector);
            var u = [];
            a.call(l, function (e) {
                var t = new Promise(function (t) {
                    e.addEventListener(n.transitionEndEvent, function (n) {
        ...
        e.exports = function (e, t) {
            var n = this;
            var r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.options.animateScroll;
            var i = 1 - this.options.scrollFriction;
            var o = this.options.scrollAcceleration;
            var s = 0;
            var a = 0;
            var l = 0;
            var u = 0;
        ...
        e.exports = function (e) {
            ...
            for (var i = 0; i < this.options.elements.length; i++) {
                if (e.querySelector(this.options.elements[i]) == null) {
                    console.warn("Element " + this.options.elements[i] + " is not in current page.")
                } else {
                    (0, r.queryAll)(this.options.elements[i]).forEach(function (o, s) {
                        (0, r.queryAll)(t.options.elements[i], e)[s].dataset.swup = n;
                        n++
                    })
                }
            }
            ...
            if (t != null) {
                if (n != null) {
                    if (this._handlers[t] && this._handlers[t].filter(function (e) {
                        ...
                        var o = this._handlers[t].indexOf(i);
                        if (o > -1) {
        ...
        e.exports = function (e) {
            ...
            var n = new i.default;
            n.setPath(e);
            if (n.getAddress() != this.currentUrl && !this.cache.exists(n.getAddress()) && this.preloadPromise == null) {
                this.getPage({
                    url: n.getAddress()
                }, function (e, r) {
                    if (r.status === 500) {
        ...
        e.exports = function () {
            var e = this;
            if (this.options.preload) {
                (0, r.queryAll)("[data-swup-preload]").forEach(function (t) {
        ...
        e.exports = function (e, t) {
            ...
            e.options = t;
            var r = function e() {
                var t = n.cache.getPage(window.location.pathname + window.location.search);
